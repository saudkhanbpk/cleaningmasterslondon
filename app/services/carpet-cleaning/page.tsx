    ...
    <div>
      ...
      <div className="flex flex-col md:flex-row gap-3 items-start">
        ...
        <div className="pt-4 flex justify-center items-center flex-col">
          <h1 className="text-center font-semibold text-purple-700 pb-2 p-3 md:p-0">Scheduling your Carpet cleaning service is easy at BOOK NOW!</h1>
          <Link href="/booknow">
          ...
          <p className="text-center text-purple-700 mt-2 p-3 md:p-0">
